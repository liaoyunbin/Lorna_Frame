...
namespace GameCreator.Runtime.Stats
{
    ...
    public class RuntimeStats
    {
        ...
        public bool Has(string _statID,out RuntimeStatData stat ){
            IdString statID = new IdString(_statID);
            stat = null;
            if (this.m_Stats == null) return false;

            if (this.m_Stats.TryGetValue(statID.Hash, out stat))
            {
                return true;
            }
