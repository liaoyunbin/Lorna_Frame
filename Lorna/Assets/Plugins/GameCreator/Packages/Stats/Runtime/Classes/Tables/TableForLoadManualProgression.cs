...
namespace GameCreator.Runtime.Stats
{
    ...
    [Serializable]
    public class TableForLoadManualProgression : TTable
    {
        // +--------------------------------------------------------------------------------------+
        // | EXP_Level(n) = X(n)                                                                  |
        // |                                                                                      |
        ...
        [SerializeField] public int[] m_Increments = new int[99];
        ...
        public TableForLoadManualProgression() : base()
        {
        ...
        public TableForLoadManualProgression(int[] increments) : this()
        {
