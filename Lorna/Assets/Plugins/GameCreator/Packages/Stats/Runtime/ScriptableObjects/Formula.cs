...
namespace GameCreator.Runtime.Stats
{
    ...
    public class Formula : ScriptableObject
    {
        ...
        public void SetFormulaData(string s, Table table)
        {
            m_Formula = s;
            m_Table = table;
        }
        ...
        {
            return data.Source != null && data.Source.Get<Traits>() != null && data.Source.Get<Traits>().RuntimeStats.Get(name) != null
        ...
        {
            return data.Source != null && data.Source.Get<Traits>() != null && data.Source.Get<Traits>().RuntimeAttributes.Get(name) != null
        ...
        {
            return data.Target != null && data.Target.Get<Traits>() != null && data.Target.Get<Traits>().RuntimeStats.Get(name) != null
        ...
        {
            return data.Target != null && data.Target.Get<Traits>() != null && data.Target.Get<Traits>().RuntimeAttributes.Get(name) != null
