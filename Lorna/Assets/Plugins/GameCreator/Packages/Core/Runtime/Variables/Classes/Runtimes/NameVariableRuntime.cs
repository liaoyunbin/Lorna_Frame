...
namespace GameCreator.Runtime.Variables
{
    ...
    public class NameVariableRuntime : TVariableRuntime<NameVariable>
    {
        ...
        public string[] KeyNameList => this.m_List.Names;
        // EVENTS: --------------------------------------------------------------------------------
        ...
        public NameVariable GetNameVariable(string name){
            return  this.AccessRuntimeVariable(name);
        }
        ...
        public void Add(string name,string typeID,object value)
        {
            ...
            //for (int i = 0; i < this.m_List.Length; ++i)
            //{
                NameVariable variable = new NameVariable(name,TValue.CreateValue(new IdString(typeID),value));

                if (variable == null) return;
                
                if (this.Variables.ContainsKey(variable.Name)) return;
