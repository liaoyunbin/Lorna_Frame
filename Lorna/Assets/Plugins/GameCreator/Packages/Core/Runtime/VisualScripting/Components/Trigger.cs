...
namespace GameCreator.Runtime.VisualScripting
{
        ...
        ISignalReceiver
    {
        ...
        void ISignalReceiver.OnReceiveSignalString(SignalArgs args,string isString)
        {
            this.m_TriggerEvent?.OnReceiveSignalString(this, args,isString);
        }
        ...
        private void RequireRigidbody3D()
        {
            ...
            // 局限于Unity的物理交互规则，方便触发OnTriggerEnter。
            // 会自动为挂载了GCTrigger的GO加上刚体，设置为IsKinematic后隐藏
