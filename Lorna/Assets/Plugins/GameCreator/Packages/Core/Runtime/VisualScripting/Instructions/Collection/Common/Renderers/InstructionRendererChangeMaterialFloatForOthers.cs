...
{
    [Title("Change Others Material Float ( 角色以外 )")]
    ...
    [Category("Renderer/Change Material Float( 角色以外 )")]
    ...
    [Serializable]
    public class RendererOthersChangeMaterialFloat : TInstructionRenderer
    {
        // MEMBERS: -------------------------------------------------------------------------------
