...
namespace GameCreator.Runtime.Common
{
	...
	public abstract class GameCreatorSingleton<T> : MonoBehaviour where T : MonoBehaviour
	{
        ...
        public static T Instance
		{
			get
			{
				if (_Instance == null)
				{
                    ...
                    GameCreatorSingleton<T> component = _Instance.GetComponent<GameCreatorSingleton<T>>();
					component.OnCreate();
