...
namespace GameCreator.Runtime.Common
{
    public class Args
    {
        ...
        [field: NonSerialized] public List<NameVariable> variables = new();
        ...
        public Args(Component self, Component target, List<NameVariable> variables = null) : this()
        {
        ...
        public Args(GameObject self, GameObject target, List<NameVariable> variables = null) : this()
        {
            this.Self = self;
            this.Target = target;
            this.variables = variables;
        ...
        public void ChangeVariables(List<NameVariable> variables)
        {
            this.variables = variables;
        }
