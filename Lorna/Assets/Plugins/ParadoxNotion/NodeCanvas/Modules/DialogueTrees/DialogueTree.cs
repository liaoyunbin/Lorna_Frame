...
namespace NodeCanvas.DialogueTrees
{
    ...
    public class DialogueTree : Graph
    {
        ...
        public class ActorParameter
        {
            ...
            [SerializeField]       private string             _lanKey;
        ...
        public static event Action<CGImgRequestInfo> OnCGImgRequest;
        ...
        ///----------------------------------------------------------------------------------------------
        public DialogueTreeController pController ;
        ...
        public IDialogueActor GetActorReferenceByName(string paramName) {
            ...
            return new ProxyDialogueActor(paramName, agent.transform);
        }
        ...
        public static void RequestMultipleChoices(MultipleChoiceRequestInfo info)
        {
         ...
         public static void RequestCGImg(CGImgRequestInfo info) {
            if (OnCGImgRequest != null)
            {
                OnCGImgRequest(info);
            }
            else {
