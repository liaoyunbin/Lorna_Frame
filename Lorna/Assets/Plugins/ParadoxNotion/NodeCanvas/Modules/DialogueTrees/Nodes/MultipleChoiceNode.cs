...
namespace NodeCanvas.DialogueTrees
{
    ...
    public class MultipleChoiceNode : DTNode
    {
        ...
        public List<Choice> choices => availableChoices;
        ...
        protected override Status OnExecute(Component agent, IBlackboard bb) {
            ...
            var optionsInfo = new MultipleChoiceRequestInfo(finalActor, finalOptions, availableTime, OnOptionSelected,title,titleLanKey);
