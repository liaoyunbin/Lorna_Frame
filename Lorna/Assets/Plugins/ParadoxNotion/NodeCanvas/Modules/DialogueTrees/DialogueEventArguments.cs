...
namespace NodeCanvas.DialogueTrees
{
    ...
    public class MultipleChoiceRequestInfo
    {
        ...
        ///<summary>for multiple choice but only text Choice </summary>
        public bool onlyText;


        public MultipleChoiceRequestInfo(IDialogueActor actor, Dictionary<IStatement, int> options, float availableTime, bool showLastStatement, Action<int> callback, bool onlyText = false)
        {
            this.actor = actor;
        ...
        public MultipleChoiceRequestInfo(IDialogueActor actor, Dictionary<IStatement, int> options, float availableTime, Action<int> callback, string title, string titleLanKey, bool onlyText = false)
        {
            this.actor = actor;
            this.title = title;
            this.titleLanKey = titleLanKey;
            this.options = options;
            this.availableTime = availableTime;
            this.SelectOption = callback;
            this.onlyText = onlyText;
    ...
    public class CGImgRequestInfo
    {
        ///<summary>The actor speaking</summary>
        public IDialogueActor actor;
        ///<summary>The statement said</summary>
        public CGNodeData data;
        ///<summary>Call this to Continue the DialogueTree</summary>
        public Action Continue;


        public CGImgRequestInfo(IDialogueActor actor, CGNodeData data, Action callback)
        {
            this.actor = actor;
            this.data = data;
            this.Continue = callback;
